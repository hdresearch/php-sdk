...
{
    public readonly string $created_at;
    public readonly string|null $expires_at;
    public readonly string $id;
    public readonly string $label;
    public readonly int|null $max_memory_mib;
    public readonly int|null $max_vcpus;

    public function __construct(
        string $created_at,
        string $id,
        string $label,
        string|null $expires_at = null,
        int|null $max_memory_mib = null,
        int|null $max_vcpus = null,
    ) {
        $this->created_at = $created_at;
        $this->expires_at = $expires_at;
        $this->id = $id;
        $this->label = $label;
        $this->max_memory_mib = $max_memory_mib;
    ...
    public static function fromArray(array $data): static
    {
        return new static(
            ...
            max_memory_mib: $data['max_memory_mib'] ?? null,
            max_vcpus: $data['max_vcpus'] ?? null,
        );
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->max_memory_mib !== null) {
            $result['max_memory_mib'] = $this->max_memory_mib;
        }
        if ($this->max_vcpus !== null) {
            $result['max_vcpus'] = $this->max_vcpus;
        }
        return $result;
    }
}
...
{
    /** File contents, base64-encoded. */
    public readonly string|null $content_b64;
...
{
    public readonly WhoamiApiKey $api_key;
    public readonly WhoamiOrg $org;
    public readonly WhoamiUser $user;

    public function __construct(
        WhoamiApiKey $api_key,
        WhoamiOrg $org,
        WhoamiUser $user,
    ) {
    ...
    {
        return new static(
            api_key: isset($data['api_key']) ? WhoamiApiKey::fromArray($data['api_key']) : null,
            org: isset($data['org']) ? WhoamiOrg::fromArray($data['org']) : null,
            user: isset($data['user']) ? WhoamiUser::fromArray($data['user']) : null,
        );
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->api_key !== null) {
            $result['api_key'] = $this->api_key->toArray();
        }
        if ($this->org !== null) {
            $result['org'] = $this->org->toArray();
        }
        if ($this->user !== null) {
